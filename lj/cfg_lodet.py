...
lr_interval = 10
data_seed = 0
weight_path =r"D:\fs0920\LODET\weight\backup_epoch95_newnovel_2.pt"#特征提取的权重

resume_path=r"D:\fs0920\LODET\weight\fs\backup_epoch249.pt"
meta_weight_path=r"D:\fs0920\LODET\weight\meta\backup_epoch9_trainval_epoch10.pt"#meta训练的权重
cmp_weight_path=r"D:\fs0920\LODET\weight\backup_epoch95_newnovel_2.pt"
Kshot = 10
lr_fs = 8e-3
weight_path_fs= r'D:\fs0920\LODET\weight\FS'
...
TEST = {
        ...
        #"EVAL_JSON":'val.json',
        "EVAL_NAME":'val5863_20',
        "EVAL_NAME_TEST":'val1500',#val5863_15特征提取,test_16测试集,val_100_new_1fs
