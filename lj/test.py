...
if __name__ == "__main__":
    ...
    parser.add_argument('--weight_path', type=str, default='weight\\best1.pt', help='weight file path')
    ...
    logger = Logger(log_file_name=opt.log_val_path + '/val_fea_1117.txt', log_level=logging.DEBUG,
