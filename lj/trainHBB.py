...
from modelR.loss.loss_hbb_base import Loss
            ...
            if epoch >= 70 and epoch % 5 == 0 and cfg.TRAIN["EVAL_TYPE"] == 'VOC':
                ...
                with torch.no_grad():
                    ...
                    for i in APs:
                        ...
                        mAP += APs[i]
                    mAP = mAP / (self.train_dataset.num_classes-5)
...
if __name__ == "__main__":
    ...
    # parser.add_argument('--weight_path', type=str, default='weight/backup_epoch65.pt',
    #                     help='weight file path') #default=None
    #parser.add_argument('--resume', action='store_true',default=True,  help='resume training flag')
    parser.add_argument('--gpu_id', type=int, default=0, help='gpu id')
    parser.add_argument('--log_path', type=str, default='log/log_fea', help='log path')
    opt = parser.parse_args()
    writer = SummaryWriter(logdir=opt.log_path + '/event')
    logger = Logger(log_file_name=opt.log_path + '/log_NWPU.txt', log_level=logging.DEBUG, logger_name='LODet-hbb').get_log()
