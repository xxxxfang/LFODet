...
class FC2_CSA_DRF_FPN(nn.Module):
    ...
    def forward(self, x0, x1, x2):
        ...
        return p_out_2,p_out_0  # small, large
        #return conv2,conv0
class N_FC_CSA_DRF_FPN(nn.Module):
    def __init__(self, fileters_in, model_size=1):
        super(N_FC_CSA_DRF_FPN, self).__init__()
        fi_0, fi_1, fi_2 = fileters_in#1280, 96, 32
        fm_0 = int(1024*model_size)
        fm_1 = fm_0//2
        fm_2 = fm_0 // 4
        self.epsilon = 1e-4
        # large
        self.__conv_set_0 = GSA(in_chs=fi_0,mid_chs = fi_0, out_chs=fm_0)
        self.__route1_0 = Route()
        self.__down1_0 = Downsample()
        ...
        # medium
        self.__conv_set_1_gsa = GSA(in_chs=fi_1, mid_chs = fi_1, out_chs=fm_1)
        self.__conv_set_1_gse = GSE(in_chs=fi_1, mid_chs = fi_1, out_chs=fm_1)
        self.__cat1 = Route()
        # self.__conv1 = Convolutional(filters_in=2*fm_1, filters_out=fm_1, kernel_size=1, stride=1, pad=0, norm="bn",
        #               activate="leaky")

        self.__conv1up2_head = nn.Conv2d(fm_1*2, fm_2, kernel_size=1, stride=1, padding=0)
        self.__conv1down0_head = nn.Conv2d(fm_1*2, fm_0, kernel_size=1, stride=1, padding=0)
        self.__upsample1_2_head = Upsample(scale_factor=2)
        self.__downsample1_0_head = Downsample()

        # small
        self.__conv_set_2 = GSE(in_chs=fi_2,mid_chs = fi_2, out_chs=fm_2)
        self.__route1_2 = Route()
        self.__upsample1_2 = Upsample(scale_factor=2)
        self.__conv2 = Convolutional(filters_in=fm_1 + fm_2, filters_out=fm_2, kernel_size=1, stride=1, pad=0, norm="bn",
                      activate="leaky")
        #self.__conv_set_2_2 = GSA(in_chs=fm_2, mid_chs=fm_2, out_chs=fm_2)
    ...
    def forward(self, x0, x1, x2):
        ...
        conv0up2_head = self.__conv0up2_head(conv0)
        upsample0_2_head_1 = self.__upsample0_2_head_1(conv0up2_head)
        upsample0_2_head_2 = self.__upsample0_2_head_2(upsample0_2_head_1)
        ...
        conv2down0_head = self.__conv2down0_head(conv2)
        downsample2_0_head_1 = self.__downsample2_0_head_1(conv2down0_head)
        downsample2_0_head_2 = self.__downsample2_0_head_2(downsample2_0_head_1)
        ...
        p_out_2 = self.swish((weight_2[0] *upsample0_2_head_2  + weight_2[1] * upsample1_2_head +
                              weight_2[2] *conv2 ))  # 0l,2s
        return p_out_2,p_out_0  # small, large
class FC_CSA_DRF_FPN(nn.Module):
    def __init__(self, fileters_in, model_size=1):
        super(FC_CSA_DRF_FPN, self).__init__()
        fi_0, fi_1, fi_2 = fileters_in#1280, 96, 32
        fm_0 = int(1024*model_size)
        fm_1 = fm_0//2
        fm_2 = fm_0 // 4
    ...
    def forward(self, x0, x1, x2):
        ...
        p_out_2 = self.swish((weight_2[0] *upsample0_2_head_2  + weight_2[1] * upsample1_2_head +
                              weight_2[2] *conv2 ))  # 0l,2s
        return p_out_2,p_out_0  # small, large
class NONE_CSA_DRF_FPN(nn.Module):
    def __init__(self, fileters_in, model_size=1):
        super(NONE_CSA_DRF_FPN, self).__init__()
        fi_0, fi_1, fi_2 = fileters_in#1280, 96, 32
        fm_0 = int(1024*model_size)#1024
        fm_1 = fm_0//2#512
        fm_2 = fm_0 // 4#256
