...
from ..head.mtr_head import MTR_Head1
...
class MSR_FPN_Lite(nn.Module):
    def __init__(self, fileters_in):

        super(MSR_FPN_Lite, self).__init__()
        ...
        self.__conv0_1 = MTR_Head1(filters_in=512, anchor_num=3, fo_class=self.__fo, temp=False)
        self.__conv1_1 = MTR_Head1(filters_in=256, anchor_num=3, fo_class=self.__fo, temp=False)
