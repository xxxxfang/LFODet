...
def visualize_boxes(image, boxes, labels, probs, class_labels):
  ...
  image=visualize_boxes_and_labels_on_image_array(image, boxes, labels, probs, category_index,groundtruth_box_visualization_color='black',)
  return image
...
def visualize_boxes_and_labels_on_image_array(
    ...
    max_boxes_to_draw=8,#0时为4
    min_score_thresh=.1,#0时为1
    agnostic_mode=False,
    line_thickness=4,
    groundtruth_box_visualization_color='black',
    #skip_scores=False,
    skip_scores=True,#显示分数False
    skip_labels=False):
